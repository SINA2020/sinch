    ...
    if is_sudo(msg) then
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 238815147}, fuck, nil)
